...
//                 var specificIndex = db.folderTask.indexWhere(
//                     (element) => element.name == db.folderTask[index].name);
...
//                   //     .folderTask
//                   //     .add(FolderTask(
//                   //         name: widget.folderTask.name ?? 'Folder',
//                   //         task: [
//                   //           Task(
//                   //                   name: taskNameController.text,
//                   //                   note: notesController.text,
...
//                 }
//               }
//               Provider.of<ToDoDatabase>(context, listen: false).updateTask();
